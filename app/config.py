...
class Settings:
    ...
    openmeteo_icon_it_url: str = os.getenv("OPENMETEO_ICON_IT_URL", "https://api.open-meteo.com/v1/forecast")
    openmeteo_icon_it_model: str = os.getenv("OPENMETEO_ICON_IT_MODEL", "italia_meteo_arpae_icon_2i")
